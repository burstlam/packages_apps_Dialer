...
public class DialpadFragment extends Fragment
    ...
    private void registerSensorListener(Sensor sensor) {
        if (sensor != null)
            mSensorManager.registerListener(mSensorListener, sensor, SensorManager.SENSOR_DELAY_FASTEST);
    }
        ...
        public void onSensorChanged(SensorEvent event) {
            ...
            if (event.sensor.equals(mProximitySensor)) {
                ...
                if (initProx) {
                    ...
                    if( SensorProximity > 0 && currentProx <= 6){
                        proxChanged = true;
                    }
                }
                SensorProximity = currentProx;
            ...
            if (rightOrientation(SensorOrientationY) && SensorProximity <= 6 && proxChanged ) {
